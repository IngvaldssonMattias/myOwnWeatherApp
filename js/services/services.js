...
export async function getWeatherFromCity(city){ // Exporterar en asynkron funktion som hämtar väderdata för en specifik stad
    ...
    if(!response.ok) // kontrollerar om HTTP-svaret är ok
...
async function getTemperature(lat, lon, city){ // skapar en asynkron funktion som hämtar temperaturen för givna koordinater
...
const weatherData = { //skapar ett objekt med väderdata
        city: city,
